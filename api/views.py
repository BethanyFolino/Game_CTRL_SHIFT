...
def console_games_view(request, console, page):
    ...
    print(url)
    return render(request, 'console_all_games.html', {'prev_page': prev_page, 'page':next_page,'data': data, 'id':id, 'game_list':game_list, 'console':console_name, 'console_slug':console})
